...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/skins/all-skins.min.css">
<style type="text/css">
html {
	overflow: hidden;
}
...
<body class="hold-transition skin-blue sidebar-mini fixed">
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="../index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>xxx</b></span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>xxx管理系统</b></span>
			</a>
								...
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#">
												<div class="pull-left">
													<img
														src="<%=request.getContextPath()%>/resources/img/user3-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img
														src="<%=request.getContextPath()%>/resources/img/user4-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
	...
	<!--tabs-->
	<script src="<%=request.getContextPath()%>/resources/js/app_iframe.js"></script>
...
<script src="../dist/js/sidebarMenu.js"></script>-->
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			App.setbasePath("../");
			App.setGlobalImgPath("resources/img/");
